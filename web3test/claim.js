...
async function main() {
    ...
    const options = {
    from:"0xA7E8c6AEB301A21d4d7A2c74718176663fB83e83",//from: "0x464595b93B6Ea445b53089D0b1DFc0a02bD40558",// Your Binance Smart Chain testnet address,
    value: 0,
    gas: 3000000
    };
    
    // Approve the spender to spend the specified amount of tokens
    await ICOContract.methods.claim().send(
        options,
